...
var gtfsRTWednesday = time.Date(2026, 8, 5, 9, 0, 0, 0, time.UTC)
...
func TestMarshalGTFSRTFeedIsAFullDataset(t *testing.T) {
	payload, err := marshalGTFSRTFeed([]*gtfs.FeedEntity{cancelledTripEntity("KHH1:0:0600:W:1111100", "20260805")}, gtfsRTWednesday)
	if err != nil {
