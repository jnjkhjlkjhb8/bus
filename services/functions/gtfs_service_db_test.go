...
func TestBusScheduleServiceID(t *testing.T) {
	...
	compare("busScheduleSource", read("busScheduleSource", busScheduleSource), map[string]string{
	...
	compare("busOriginTripSource", read("busOriginTripSource", busOriginTripSource), map[string]string{
