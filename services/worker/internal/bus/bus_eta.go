...
type busLiveJob struct {
	...
	// city every tick. Only the TDX-backed job sets it: EtaFast reads
...
// (EtaFast, live.go "@every 20s" — see busEtaFastTickInterval for why 20s
...
// EtaFast refreshes busEtaFastCities' live bus arrivals on their own 15s
