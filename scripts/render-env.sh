...
# file, filled in exactly as before — and produces five per-service env files
...
#
# This was chosen over splitting env/<env>.env itself into five
...
#   Writes <output-dir>/{router,functions,ingestor,loader,powersync}.env.
