...
void main() {
  test('heading 0 selects frame 00 (north)', () {
    expect(busSpriteAsset(0), 'assets/sprites/bus_00.webp');
  });

  test('heading 360 wraps to the same frame as heading 0', () {
    expect(busSpriteAsset(360), busSpriteAsset(0));
    expect(busSpriteAsset(360), 'assets/sprites/bus_00.webp');
  });
  ...
  test('heading 359.9 rounds up and wraps to frame 00, not frame 60', () {
    ...
    expect(busSpriteAsset(359.9), 'assets/sprites/bus_00.webp');
  });

  test('heading 180 selects frame 30 (south)', () {
    expect(busSpriteAsset(180), 'assets/sprites/bus_30.webp');
  });
  ...
  test(
    ...
    () {
      ...
      expect(busSpriteAsset(3), 'assets/sprites/bus_01.webp');
    },
  );
  ...
  test('a small negative heading wraps into the top of the frame range', () {
    ...
    expect(busSpriteAsset(-6), 'assets/sprites/bus_59.webp');
  });
}
